...
#set_output_delay -clock [get_clocks -of_objects [get_pins clock_gen/clk_out1]] 10.000 [get_ports txd]
  set_input_delay -clock clk_50M 3.000 [get_ports {base_ram_data[*]}]
  set_input_delay -clock clk_50M 3.000 [get_ports {ext_ram_data[*]}]
  set_input_delay -clock clk_50M 2.000 [get_ports reset_btn]
  set_input_delay -clock clk_50M 1.500 [get_ports rxd]
  ...
  set_output_delay -clock clk_50M 2.000 [get_ports ext_ram_ce_n]
  set_output_delay -clock clk_50M 1.500 [get_ports txd]
